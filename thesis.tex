...
% Refine the toc style to the latest standard - Shanhe
...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdfauthor={YOUR NAME}, % REPLACE these for pdf metadata -- Kevin
    pdftitle={Dissertation},
    pdfsubject={
        YOUR DISSERTATION TITLE},
    pdfkeywords={OPTIONAL KEYWORDS},
...
% If your title and any chapter/sections/subsections... include LaTeX, you can use 
% "/texorpdfstring{LaTeX}{text symbols}" to have it print correctly, for example 
% "\texorpdfstring{$\omega\pi^0$}{ωπ⁰}". Just google "unicode superscript 0" for example
% to copy the right symbol -- Kevin
...
% If you are a doctoral candidate defending your thesis, you will have two separate dates listed.
% - \defenseMonth, \defenseYear is the month and year of your defense date, which appears on your approval page and copyright page
% - \graduationMonth and \graduationYear are the expected conferment month and year of your degree, [e.g. January, May, August]. 
% Check with the Office of Graduate Studies and Research to verify the actual graduation month and year.
% If you do not have a defense, you should be able to make these the same dates -- Kevin
\defenseMonth{April}
\defenseYear{2026}
\graduationMonth{May}
\graduationYear{2026}
\thesisAdvisor{Professor Advisor Name} % Advisor name with title
...
%% If you received your masters from William & Mary, this must be written as "William and Mary" like in the example here. -- Kevin
\thesisDegreeOne{Master of Science, William and Mary, 2022}
\thesisDegreeTwo{Bachelor of Engineer, ABC College, 2016}
...
%%-- Committee members
% Current guidelines (2026) still require that W&M committee members must be listed with "College of William \& Mary" -- Kevin
%% example 
%%  \thesisCommittee[Department]{John Doe, Professor}{ABC College}
%%  \thesisCommittee{John Doe}{XYZ Company}
%%  \thesisCommittee[Copration Department]{John Doe}{XYZ Company}
\thesisCommittee[Computer Science]{A, Professor}{College of William \& Mary}  % use {College of William \& Mary} -- Shanhe
\thesisCommittee[Computer Science]{B, Associate Professor}{College of William \& Mary}
\thesisCommittee[Computer Science]{C, Assistant Professor}{College of William \& Mary}
\thesisCommittee[Electrical and Computer Engineering]{D, Professor}{College of William \& Mary}
\thesisCommittee[Experimental Nuclear Physics]{JLab Example Member, Staff Scientist}{Thomas Jefferson National Accelerator Facility}
